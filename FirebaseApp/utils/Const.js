...
//Messages
export const GENREMSGTITLE = 'Choose GENRE from one of the linkes below. Then click on the specific Series that you are interested in to view all shows available in that series.';
...
export const APPLESTORE_ICON = require('@assets/signup/appleStoreIcon.png');
export const PLAYSTORE_ICON = require('@assets/signup/playStoreIcon.png');
...
export const PLAY = require('@assets/Player/play.png');
...
//Google Analytics
export const GA_TRACKER_ID = 'UA-127565011-1';
...
// Array Constant
export const RECENTLY_PLAYED_OPTION = ['Air Date','Episode Name','Series Name'];
